...
To access your memory from AI tools like Claude Code or OpenClaw, install the skill:
...
If you're running a self-hosted instance, configure the endpoint before logging in:

```bash
scx endpoint set https://your-instance.com/api
```

See [Self-Hosting](/docs/self-hosting) for more details.
